...
public abstract class SMPPEventAdapter implements ConnectionObserver {
    ...
    public final void update(Connection source, netty.smpp.api.event.SMPPEvent event) {
        try {
            switch (event.getType()) {
                case netty.smpp.api.event.SMPPEvent.RECEIVER_START:
                    receiverStart(source, (ReceiverStartEvent) event);
                    break;

                case netty.smpp.api.event.SMPPEvent.RECEIVER_EXIT:
                ...
                case netty.smpp.api.event.SMPPEvent.RECEIVER_EXCEPTION:
     ...
     */
    public void userEvent(Connection source, netty.smpp.api.event.SMPPEvent ev) {
        // default: do nothing
    }
