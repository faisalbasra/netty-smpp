...
public abstract class SmscLink {
     ...
     *
     * @throws java.io.IOException If an exception occurs while opening the connection.
     */
     ...
     * from the SMPP link (using {@link netty.smpp.api.Connection#unbind}) before
     * closing the underlying network link. The connection may be reestablished
     * using {@link #open}.
     *
     * @throws java.io.IOException If an exception occurs while closing the connection.
     */
     ...
     * @throws java.io.IOException if an exception occurs during writing or if the connection is
     *                             not open.
     */
     ...
     *
     * @throws java.io.IOException If an exception occurs while flushing the output stream.
     */
     ...
     *
     * @see #setAutoFlush
     * @see netty.smpp.api.util.APIConfig
     */
     ...
     *
     * @param array a byte array buffer to read the packet into.
     * @return the handle to the passed in buffer or the reallocated one.
     * @throws java.io.EOFException If the end of stream is reached before a full packet can be
     *                              read.
     * @throws java.io.IOException  If an exception occurs when reading the packet from the input
     *                              stream.
     */
     ...
     *
     * @throws java.io.IOException If the output stream cannot be retrieved or the connection is
     *                             not open.
     */
     ...
     *
     * @throws java.io.IOException If the input stream cannot be retrieved or the connection is
     *                             not open.
     */
     ...
     * @throws UnsupportedOperationException if the implementation does not support timeouts.
     * @see #setTimeout
     */
     ...
     *
     * @param snoopIn  stream to receive incoming bytes from the SMSC (may be null).
     * @param snoopOut stream to receive outgoing bytes to the SMSC (may be null).
     */
