 ...
 */
public class TcpLink extends netty.smpp.api.net.SmscLink {
     ...
     *
     * @throws java.io.IOException If an error occurs while creating the socket connection to
     *                             the SMSC.
     ...
     *
     * @throws java.io.IOException If an I/O error occurs closing the socket connection.
     ...
     *
     * @throws java.io.IOException If the socket connection is not open or an I/O error occurs
