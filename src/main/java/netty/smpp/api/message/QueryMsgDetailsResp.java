 ...
 * @version 1.0
 */
public class QueryMsgDetailsResp extends netty.smpp.api.message.SMPPResponse {
    /**
     * Table of destinations the message was routed to
     */
    private netty.smpp.api.message.DestinationTable destinationTable = new netty.smpp.api.message.DestinationTable();
     ...
     */
    public QueryMsgDetailsResp(netty.smpp.api.message.QueryMsgDetails r) {
        super(r);
     ...
     * @return The current number of destination addresses (including the new
     * @throws netty.smpp.api.message.InvalidParameterValueException if the distribution list name is too long.
     */
     ...
     */
    public netty.smpp.api.message.DestinationTable getDestinationTable() {
    ...
    protected void encodeBody(OutputStream out) throws java.io.IOException {
        ...
        netty.smpp.api.message.DestinationTable table = (netty.smpp.api.message.DestinationTable) destinationTable.clone();
    ...
    public void readBodyFrom(byte[] body, int offset)
        ...
        try {
            ...
            netty.smpp.api.message.DestinationTable dt = new DestinationTable();
