 ...
 * @version 1.0
 */
public class ParamRetrieve extends netty.smpp.api.message.SMPPRequest {
    /**
     ...
     * @throws netty.smpp.api.message.InvalidParameterValueException if the parameter name is too long.
     */
