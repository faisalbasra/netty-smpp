 ...
 * @version 1.0
 */
public class QueryLastMsgs extends netty.smpp.api.message.SMPPRequest {
    /**
     ...
     * @throws netty.smpp.api.message.InvalidParameterValueException if the count is set outside the valid range.
     */
