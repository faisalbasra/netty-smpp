...
import netty.smpp.api.message.tlv.TLVTable;
...
public abstract class SMPPPacket {
     ...
     * @see netty.smpp.api.version.SMPPVersion#getDefaultVersion
     */
     ...
     *
     * @throws netty.smpp.api.message.InvalidParameterValueException If <code>p</code> is not a valid value for the priority
     *                                                               flag.
     */
     ...
     * Set 'registered delivery' flag.
     *
     * @throws netty.smpp.api.message.InvalidParameterValueException If <code>r</code> is not a valid value for the registered
     *                                                               delivery flag.
     */
     ...
     *
     * @throws netty.smpp.api.message.InvalidParameterValueException If <code>rip</code> is not a valid value for the replace if
     *                                                               present flag.
     */
     ...
     *
     * @throws netty.smpp.api.message.InvalidParameterValueException If the value passed is not a valid ESM class.
     * @see netty.smpp.api.util.GSMConstants
     */
     ...
     *
     * @see netty.smpp.api.util.GSMConstants
     * @deprecated netty.smpp.api.message.SMPPPacket#setProtocolID
     */
     ...
     *
     * @throws netty.smpp.api.message.InvalidParameterValueException If the protocol ID supplied is invalid.
     * @see netty.smpp.api.util.GSMConstants
     */
     ...
     *
     * @throws netty.smpp.api.message.InvalidParameterValueException If the data coding supplied is invalid.
     * @see netty.smpp.api.util.GSMConstants
     */
     ...
     * is obtained using
     * {@link netty.smpp.api.util.EncodingFactory#getDefaultAlphabet}. If, at some
     * point, the encoding for the message has been altered to be one other than
     * a sub-class of {@link netty.smpp.api.util.AlphabetEncoding} then calls to
     ...
     * @throws netty.smpp.api.message.InvalidParameterValueException If the message text is too long.
     * @see netty.smpp.api.util.EncodingFactory
     * @see netty.smpp.api.util.DefaultAlphabetEncoding
     */
     ...
     * @throws netty.smpp.api.message.InvalidParameterValueException If the message text is too long.
     * @see netty.smpp.api.util.AlphabetEncoding
     * @see netty.smpp.api.util.AlphabetEncoding#getDataCoding
     * @see netty.smpp.api.util.DefaultAlphabetEncoding
     */
     ...
     * @throws netty.smpp.api.message.InvalidParameterValueException If the message data is too long.
     */
     ...
     *                 message. If null, uses netty.smpp.api.util.BinaryEncoding.
     * @throws netty.smpp.api.message.InvalidParameterValueException If the message data is too long.
     * @throws ArrayIndexOutOfBoundsException                        if start or len is less than zero or if the byte array length
     ...
     * not text.
     * @see #getMessageText(netty.smpp.api.util.AlphabetEncoding)
     * @see #setMessageText(String, netty.smpp.api.util.AlphabetEncoding)
     */
     ...
     * @throws netty.smpp.api.message.InvalidParameterValueException if the service type is too long.
     */
     ...
     * @throws netty.smpp.api.message.InvalidParameterValueException If the message ID is invalid.
     */
     ...
     * @see netty.smpp.api.util.PacketStatus
     */
     ...
     *
     * @see netty.smpp.api.message.tlv.TLVTable
     */
     ...
     * {@link netty.smpp.api.message.tlv.TLVTable#set}on this message's optional
     * parameter table.
     *
     ...
     * @throws netty.smpp.api.message.tlv.BadValueTypeException if the type of <code>value</code> is incorrect for the
     *                                                          <code>tag</code>.
     */
     ...
     * {@link netty.smpp.api.message.tlv.TLVTable#get}on this message's optional
     * parameter table.
     *
     ...
     * method and merely calls {@link netty.smpp.api.message.tlv.TLVTable#isSet}on
     ...
     * {@link netty.smpp.api.util.MessageEncoding#getDataCoding}.
     *
     ...
     *            {@link netty.smpp.api.util.EncodingFactory#getDefaultAlphabet()} will be used.
     ...
     *
     * @param out          The OutputStream to use
     * @param withOptional true to send optional parameters over the link, false to only
     ...
     *               fields from.
     * @throws netty.smpp.api.message.SMPPProtocolException if there is an error parsing the packet fields.
     */
