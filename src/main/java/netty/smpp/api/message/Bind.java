 ...
 * @version 1.0
 */
public abstract class Bind extends netty.smpp.api.message.SMPPRequest {
    /**
     * System Id
     */
     ...
     * @throws netty.smpp.api.message.InvalidParameterValueException If the system ID fails version validation.
     */
     ...
     * @throws netty.smpp.api.message.InvalidParameterValueException If the password fails version validation.
     */
     ...
     * @throws netty.smpp.api.message.InvalidParameterValueException If the system type fails version validation.
     */
     ...
     * @throws netty.smpp.api.message.InvalidParameterValueException If the TON fails version validation.
     */
     ...
     * @throws netty.smpp.api.message.InvalidParameterValueException If the NPI fails version validation.
     */
     ...
     * @throws netty.smpp.api.message.InvalidParameterValueException If the address range fails version validation.
     */
    ...
    public void readBodyFrom(byte[] body, int offset)
        ...
        } catch (netty.smpp.api.version.VersionException x) {
