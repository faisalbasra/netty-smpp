 ...
 * @version 1.0
 */
public class ParamRetrieveResp extends netty.smpp.api.message.SMPPResponse {
    /**
     ...
     */
    public ParamRetrieveResp(netty.smpp.api.message.ParamRetrieve r) {
        super(r);
    }
     ...
     *          characters)
     * @throws netty.smpp.api.message.InvalidParameterValueException if the parameter value is too long.
     */
