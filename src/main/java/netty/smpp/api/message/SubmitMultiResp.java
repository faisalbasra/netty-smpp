...
import netty.smpp.api.ErrorAddress;
 ...
 * @version 1.0
 */
public class SubmitMultiResp extends netty.smpp.api.message.SMPPResponse {
    /**
     ...
     */
    public SubmitMultiResp(netty.smpp.api.message.SubmitMulti r) {
        super(r);
    }
