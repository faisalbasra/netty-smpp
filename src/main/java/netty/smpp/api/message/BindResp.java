 ...
 * @version 1.0
 */
public abstract class BindResp extends netty.smpp.api.message.SMPPResponse {
    /**
     * System Id
     */
     ...
     */
    public BindResp(netty.smpp.api.message.Bind req) {
        super(req);
    }
     ...
     * @throws netty.smpp.api.message.InvalidParameterValueException if the system id is too long.
     */
