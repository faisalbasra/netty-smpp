 ...
 * @version 1.0
 */
public class QueryLastMsgsResp extends netty.smpp.api.message.SMPPResponse {
    /**
     ...
     */
    public QueryLastMsgsResp(netty.smpp.api.message.QueryLastMsgs r) {
        super(r);
    }
     ...
     * @throws netty.smpp.api.message.InvalidParameterValueException if the id is invalid.
     */
