...
public final class Tag implements java.io.Serializable {
     ...
     *
     * @see netty.smpp.api.message.tlv.Encoder
     */
     ...
     * @throws netty.smpp.api.message.tlv.TagDefinedException If a tag with integer value <code>tag</code> has already
     *                                                        been defined.
     */
     ...
     * @param tag         The integer value of the tag.
     * @param type        The allowed Java type for the value
     * @param enc         The encoding class to use to encode and decode values.
     * @param fixedLength The fixed length allowed for the value.
     * @throws netty.smpp.api.message.tlv.TagDefinedException If a tag with integer value <code>tag</code> has already
     *                                                        been defined.
     */
     ...
     * @throws netty.smpp.api.message.tlv.TagDefinedException if an attempt is made to define a tag with a integer value
