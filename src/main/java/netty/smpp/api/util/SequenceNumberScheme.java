 ...
 * interface provide a {@link netty.smpp.api.Connection}with a unique number for
 ...
 * {@link netty.smpp.api.util.DefaultSequenceScheme}) counts monotonically from 1 upwards for each
