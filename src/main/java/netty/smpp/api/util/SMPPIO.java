...
public final class SMPPIO {
     ...
     * @param len The number of bytes to form the integer from (usually either 1
     *            or 4, limited to 1 &lt;= len &lt;= 8)
     * @return An integer representation of the len bytes read from in.
     * @throws java.io.IOException If EOS is reached before <code>len</code> bytes are read.
     ...
     *               bytes to generate).
     * @param array  the byte array to write the integer to.
     ...
     *
     * @param s   The String to write
     * @param len The length of the String to write. If this is longer than the
