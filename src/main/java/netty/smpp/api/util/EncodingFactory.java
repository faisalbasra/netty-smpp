 ...
 * types:
 * <ul>
 * <li>{@link netty.smpp.api.util.DefaultAlphabetEncoding}</li>
 * <li>{@link netty.smpp.api.util.ASCIIEncoding}</li>
 * <li>{@link netty.smpp.api.util.Latin1Encoding}</li>
 * <li>{@link netty.smpp.api.util.BinaryEncoding}</li>
 * <li>{@link netty.smpp.api.util.UCS2Encoding} (only if the JVM supports the UCS2 charset).</li>
 * </ul>
 * <p/>
...
public class EncodingFactory {
    ...
    public EncodingFactory() {
        ...
        addEncoding(new netty.smpp.api.util.ASCIIEncoding());
        addEncoding(new netty.smpp.api.util.BinaryEncoding());
        addEncoding(netty.smpp.api.util.Latin1Encoding.class);
        addEncoding(netty.smpp.api.util.UCS2Encoding.class);
        ...
        try {
            addEncoding(new netty.smpp.api.util.UCS2Encoding());
     ...
     * a sub-class of {@link netty.smpp.api.util.MessageEncoding} and must have a
     ...
     * alphabet is usually {@link netty.smpp.api.util.DefaultAlphabetEncoding}. This can be altered
     * by setting the <b>smpp.default_alphabet </b> system property to the name
     * of an implementation of {@link netty.smpp.api.util.AlphabetEncoding}.
     * <p/>
     * <p/>
     * For example:<br />
