 ...
 * <td>Boolean</td>
 * <td>By default, the {@link netty.smpp.api.net.SmscLink}class automatically
 ...
 * {@link netty.smpp.api.event.EventDispatcher}which will be used as the default
 ...
 * {@link netty.smpp.api.event.ThreadedEventDispatcher}class.</td>
 * </tr>
 * <p/>
 * <tr>
 ...
 * <code>netty.smpp.api.event.ThreadedEventDispatcher</code> class.</td>
 * </tr>
 * <p/>
 * </table>
 */
public final class APIConfig extends Properties {
     ...
     * @throws netty.smpp.api.util.PropertyNotFoundException if <code>property</code> is not found in the configuration.
     */
     ...
     *                     not set.
     * @return The value for <code>property</code>.
     * @throws netty.smpp.api.util.InvalidConfigurationException If the value cannot be parsed as
     *                                                           a <code>short</code>.
     */
     ...
     * @throws netty.smpp.api.util.PropertyNotFoundException     if <code>property</code> is not found in the configuration.
     * @throws netty.smpp.api.util.InvalidConfigurationException if the value is not a valid short.
     */
     ...
     * @throws netty.smpp.api.util.InvalidConfigurationException if the value is not a valid integer.
     */
     ...
     * @param property     the name of the property to retrive.
     * @param defaultValue the value to return if the property does not exist.
     * @throws netty.smpp.api.util.InvalidConfigurationException if the value is not a valid long.
     */
     ...
     * @param defaultValue the value to return if the property does not exist.
     * @throws netty.smpp.api.util.InvalidConfigurationException if the property has a value that cannot be parsed or
