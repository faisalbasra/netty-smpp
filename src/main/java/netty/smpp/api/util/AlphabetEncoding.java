...
import netty.smpp.api.SMPPRuntimeException;
 ...
 */
public class AlphabetEncoding extends netty.smpp.api.util.MessageEncoding {
     ...
     * @throws java.io.UnsupportedEncodingException If the JVM does not support the
